...
var create_jbig2_polyfill_module = (() => {
...
function findWasmBinary() {
  return locateFile('jbig2-polyfill.wasm');
}
...
var _jbig2_to_bmp = Module['_jbig2_to_bmp'] = makeInvalidEarlyAccess('_jbig2_to_bmp');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['jbig2_to_bmp'] != 'undefined', 'missing Wasm export: jbig2_to_bmp');
  ...
  _jbig2_to_bmp = Module['_jbig2_to_bmp'] = createExportWrapper('jbig2_to_bmp', 3);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = create_jbig2_polyfill_module;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = create_jbig2_polyfill_module;
} else if (typeof define === 'function' && define['amd'])
  define([], () => create_jbig2_polyfill_module);
